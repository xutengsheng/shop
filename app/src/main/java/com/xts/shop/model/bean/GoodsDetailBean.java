...
public class GoodsDetailBean {
    ...
    public static class GoodsDetailListBean<T> implements MultiItemEntity {
        public static final int TYPE_BANNER = 1;
        public static final int TYPE_HTML = 2;
        public static final int TYPE_TITLE = 3;
        public static final int TYPE_GOODS_LIST = 4;
        public static final int TYPE_ISSUE = 5;
    ...
    public static class DataBean{
        ...
        public static class InfoBean {
            ...
            private float app_exclusive_price;
            ...
            public float getApp_exclusive_price() {
                return app_exclusive_price;
            }

            public void setApp_exclusive_price(float app_exclusive_price) {
